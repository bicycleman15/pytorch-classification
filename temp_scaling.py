...
def main():
    ...
    ss = torch.utils.data.sampler.SubsetRandomSampler(indices[:int(0.2 * len(full_testset))])
    ...
    for t in tqdm([1.0, 1.2, 1.5, 1.7, 1.9, 2.0, 2.3, 2.5, 2.7, 3.0, 3.5, 4.0, 4.6, 5.0, 5.5]):
